...
############################################################################
# Генератор статистики для binkd   v. 0.1 beta4 Christmas version
# (c) Dmitry Sergienko, 2:464/910@fidonet, dmitry@trifle.net  06.01.2002
# Тестировалось под perl 5.005_03 for i386-linux
# binkd 0.9.3h
# Для корректной работы уровень детализации лога binkd должен быть >= 2
# Freeware, распространяется "AS IS".
############################################################################
